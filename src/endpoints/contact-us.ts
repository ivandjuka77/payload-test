...
export function contactUsEn({ contactForm }: ContactUsArgs) {
  return {
    title: 'Contact',
    hero: {
      type: 'minimal',
...
export function contactUsSk({ contactForm }: ContactUsArgs) {
  return {
    title: 'Kontakt',
    hero: {
      type: 'minimal',
      title: 'Kontaktujte nás',
      description: 'Tu nás môžete kontaktovať',
      cta: {
        links: [],
      },
      media: null,
...
export function contactUsJp({ contactForm }: ContactUsArgs) {
  return {
    title: 'お問い合わせ',
    hero: {
      type: 'minimal',
      title: 'お問い合わせ',
      description: 'こちらからお問い合わせいただけます',
      cta: {
        links: [],
      },
      media: null,
