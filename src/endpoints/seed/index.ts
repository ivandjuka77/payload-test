  ...
  const [
    ...
    payload.create({
      ...
      data: aboutUsPageDataEn({
        ...
        atbelDoc: teamMembers.atbelDoc,
        cosmeticsDoc: teamMembers.cosmeticsDoc,
        hrDoc: teamMembers.hrDoc,
        productionDoc: teamMembers.productionDoc,
        economicsDoc: teamMembers.economicsDoc,
    ...
    payload.create({
      ...
      data: contactUsPageDataEn({
        ...
        contactUsCastleImage: media.contactUsBojniceImageDoc,
      }),
    }),
  ])
